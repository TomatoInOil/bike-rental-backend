...
def test_calculate_total_cost(start_time, end_time, rental_cost_per_hour, expectation):
...
def test_record_rental_completion(
    request, mocker, user_with_rental, rental_cost_per_hour, mock_now
):
...
def test_check_no_active_rental(request, user):
